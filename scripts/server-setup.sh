...
#
#   curl -fsSL https://raw.githubusercontent.com/distapcher/AI-Numerolog/main/scripts/server-setup.sh | bash
#
# Or after cloning:
...
REPO_URL="${REPO_URL:-https://github.com/distapcher/AI-Numerolog.git}"
DEPLOY_DIR="${DEPLOY_DIR:-/opt/AI-Numerolog}"
BRANCH="${BRANCH:-main}"
